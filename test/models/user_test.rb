...
class UserTest < ActiveSupport::TestCase
  ...
  test "name should not be longer than 255 characters" do
    @user.name = "a" * 256
    assert_not @user.valid?
  end
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[user@exaple.com USER@foo.com A_US-ER@foo.bar.org first.last@foo.jp alice+bob@baz.cn]
